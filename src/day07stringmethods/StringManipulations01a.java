...
public class StringManipulations01a {
	
	/*
 	String Methods:
 	1)toUpperCase() 2)toLowerCase 3)charAt()     4)equals()         5)equalsIgnoreCase() 6)length()
 	7) next()       8)nextLine()  9)indexOf()    10) lastIndexOf()  11) contains()       12)starsWith()
 	13)endsWith()   14)isEmpty()  15)replace()   16) replaceAll()   17) replaceFirst()
 */
	...
	public static void main(String[] args) {
		...
		//is used for the check if this string starts with the specific prefix.
		//Can be used with only String. We cant use it with char
		//Can be used with more than one characters
		//returns boolean
		...
		//is used for the check if this string starts with the specific suffix.
		//Can be used with only String. We can't use it with char
		//Can be used with more than one characters
		//returns boolean
		...
		//returns boolean, true means the length of the String is equal to 0
