...
public class C3_LinkedList03 {
	...
	public static void main(String[] args) {
		...
		System.out.println(ll1.remove(0)); // remove(index) indexdeki elemani siler ve bize dondurur
		...
		ll1.addFirst("B");
		System.out.println(ll1); // [B, A, B] en basa B ekledi
		
		System.out.println(ll1.removeFirstOccurrence("B")); // true veya false dondurur
		System.out.println(ll1); // [A, B] ilk buldugu B'yi sildi
