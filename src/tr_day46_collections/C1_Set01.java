...
public class C1_Set01 {
	...
	public static void main(String[] args) {
		...
		// Set'd onemli olan ozellik No duplication ve elemanin kumede var olup olmamasidir
		// Siralama Set icin onemli degildir
		// Set icin elemanlari girdiginiz sirada verir veya elemanlari natural siralama ile verir
