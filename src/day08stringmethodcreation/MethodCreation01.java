...
public class MethodCreation01 {
	...
	public static void main(String[] args) {
		...
		System.err.println(add(3.4,5.6));
	...
	/*
	 	...
	 	2) Static method can use just static class members because of that we have to make our methods to be able to call them from main method
	 	3) The variables which are created in method parenthesis are called parameters ==> num1 and num2
	...
	/*
	 	Method Overloading
	 	If you create method whose name are same and parameters are different in a class
	 	it is called "method overloading"
	 	
	 	When you use same name for in a class, Java complains to stop complaining we have to change parameters
