...
public class ConvertStringToNumber {
	...
	public static void main(String[] args) {
		...
		//parseInt() method converts String to integer if and only if the String is created just by numbers
		System.out.println((Integer.parseInt(str1)+Integer.parseInt(str2))/100.0);
		//valueOf() method converts String to integer if and only if the String is created just by numbers
